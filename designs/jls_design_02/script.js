document.addEventListener("DOMContentLoaded", () => {
    ...
    const dockItems = [
        ...
        { title: "Components", icon: '<i class="fas fa-puzzle-piece"></i>', href: "#" },
        { title: "Settings", icon: '<i class="fas fa-cog"></i>', href: "#" },
        { title: "Aceternity UI", icon: '<img src="https://assets.aceternity.com/logo-dark.png" class="icon-img" alt="Aceternity Logo">', href: "#" },
